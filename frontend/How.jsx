  ...
  const steps = [
    {
      ...
      details:
        "Our sensors and integrations automatically capture comprehensive farm data including soil moisture, temperature, humidity, and GPS location.",
      benefits: [
    ...
    },
    {
      ...
      details:
        "Advanced machine learning models analyze patterns from thousands of farms to provide personalized insights specific to your region.",
      benefits: [
    ...
    },
    {
      ...
      details:
        "Get evidence-based recommendations for crop selection, planting schedules, and resource optimization tailored to your farm.",
      benefits: [
        "Yield optimization",
        "Cost reduction",
        "Sustainability",
    ...
    },
    {
      ...
      details:
        "Receive real-time weather alerts, forecasts, and climate insights to help you plan farming activities effectively.",
    ...
    },
    {
      ...
      details:
        "Access all your farm data, recommendations, and insights from any device with an intuitive, user-friendly interface.",
      benefits: [
        "Mobile-first design",
        "Real-time updates",
        "Offline access",
    ...
    },
    {
      ...
      details:
        "See measurable improvements in crop yield, resource efficiency, and farm profitability within the first season.",
  ...
  return (
    <section className="howitworks">
      ...
      <div className="cta-section">
        ...
        <p>
          Start using our platform today and see the difference in your crop
