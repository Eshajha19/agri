    ...
    <div className="risk-container">
      ...
      <footer className="risk-footer">
        <div className="disclaimer">
          <p><strong>Note:</strong> This risk index is generated by <span translate="no">Fasal Saathi</span>'s analytical engine based on regional data trends. For official insurance quotes, please consult with registered financial providers.</p>
        </div>
      </footer>
    </div>
  );
