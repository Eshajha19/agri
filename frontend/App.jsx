    ...
    <div className={`app ${isDarkTheme ? "theme-dark" : ""}`}>
      ...
      <nav className={`navbar ${isOpen ? "menu-open" : ""}`} role="navigation" aria-label="Main Navigation">
        ...
        <div className="nav-right">
          <button onClick={handleThemeToggle} className="theme-toggle" aria-label="Toggle Theme">
            {isDarkTheme ? <FaSun className="theme-toggle-icon" /> : <FaMoon className="theme-toggle-icon" />}
          </button>
      ...
      <main id="main-content" tabIndex="-1" style={{ outline: 'none' }}>
        <Routes>
          ...
          <Route path="/prediction" element={<SmartCropRecommendation />} />
          <Route path="/crop-prediction" element={<SmartCropRecommendation />} />
          <Route path="/disease-detection" element={<CropDiseaseDetection />} />
          <Route path="/fertilizer" element={<FertilizerRecommendation />} />
          <Route path="/smart-recommendation" element={<SmartCropRecommendation />} />
